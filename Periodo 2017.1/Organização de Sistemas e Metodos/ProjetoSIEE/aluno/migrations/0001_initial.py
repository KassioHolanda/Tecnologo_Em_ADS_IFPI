    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('escolaridade', models.CharField(blank=True, choices=[('ensino_medio', 'ENSINO MEDIO'), ('ensino_superior', 'ENSINO SUPERIOR'), ('tecnico', 'TECNINO')], max_length=255, null=True, verbose_name='Escolaridade')),
